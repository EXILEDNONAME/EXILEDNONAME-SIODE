...
@push('content-body')
{ data: 'jasamarga_locations.name', 'className': 'text-nowrap', 'width': '1' },
{ data: 'jasamarga_devices.name', 'className': 'text-nowrap', 'width': '1' },
{ data: 'name' },
  ...
  <div class="col-sm-3">
    <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 20% auto; background-image: url(/assets/backend/media/svg/shapes/abstract-1.svg)">
      <div class="card-body">
        ...
        <span class="font-weight-bold font-size-sm">{{ \DB::table('jasamarga_users')->where(['id_device' => '4', 'active' => '1'])->count() }} items </span>
      </div>
    </div>
  </div>
  <div class="col-sm-3">
    <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 20% auto; background-image: url(/assets/backend/media/svg/shapes/abstract-1.svg)">
      <div class="card-body">
        ...
        <span class="font-weight-bold font-size-sm">{{ \DB::table('jasamarga_users')->where(['printer' => '1', 'active' => '1'])->count() }} items </span>
      </div>
    </div>
  </div>
  <div class="col-sm-3">

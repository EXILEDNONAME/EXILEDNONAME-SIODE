<div class="kt-section__body">
  ...
  <div class="form-group row">
    ...
    <div class="col-lg-9">
      {!! Form::select('id_device', dishub_devices(), (isset($data->id_device) ? $data->id_device : NULL), ['placeholder' => '- Select Device -', 'class' => 'form-control', 'required' => 'required']) !!}
  ...
  <div class="form-group row">
    ...
    <div class="col-lg-9">
      {!! Form::select('id_location', dishub_locations(), (isset($data->id_location) ? $data->id_location : NULL), ['placeholder' => '- Select Location -', 'class' => 'form-control', 'required' => 'required']) !!}
      @error('id_location') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
    </div>
  </div>

  <div class="form-group row">
    <label class="col-lg-3 col-form-label"> ID Employee </label>
    <div class="col-lg-9">
      {!! Form::text('id_employee', (isset($data->id_employee) ? $data->id_employee : ''), ['class' => $errors->has('id_employee') ? 'form-control is-invalid' : 'form-control']) !!}
      @error('id_employee') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
    </div>
  </div>
  ...
  <div class="form-group row">
    <label class="col-lg-3 col-form-label"> MAC </label>
    <div class="col-lg-9">

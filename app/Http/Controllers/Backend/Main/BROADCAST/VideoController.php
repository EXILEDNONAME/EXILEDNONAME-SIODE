...
use App\Http\Requests\Backend\Main\BROADCAST\Video\VideoStoreRequest;
use App\Http\Requests\Backend\Main\BROADCAST\Video\VideoUpdateRequest;
...
class VideoController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/broadcast/videos';
    $this->path = 'pages.backend.main.broadcast.video';
    $this->model = 'App\Models\Backend\Main\BROADCAST\Video';
  }

...
use App\Http\Requests\Backend\Main\BROADCAST\Content\ContentStoreRequest;
use App\Http\Requests\Backend\Main\BROADCAST\Content\ContentUpdateRequest;
...
class ContentController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/broadcast/contents';
    $this->path = 'pages.backend.main.broadcast.content';
    $this->model = 'App\Models\Backend\Main\BROADCAST\Content';
  }

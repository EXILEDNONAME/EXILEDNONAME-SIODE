...
use App\Http\Requests\Backend\Main\SESKO\Packet\PacketStoreRequest;
use App\Http\Requests\Backend\Main\SESKO\Packet\PacketUpdateRequest;
...
class PacketController extends Controller {
  ...
  **/
  ...
  public function store(PacketStoreRequest $request) {
    $store = $request->all();
  ...
  **/
  ...
  public function update(PacketUpdateRequest $request, $id) {
    $data = $this->model::findOrFail($id);
    $update = $request->all();
    $data->update($update);
